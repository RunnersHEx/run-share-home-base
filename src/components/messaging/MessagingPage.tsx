...
import { MessageCircle, Users, Clock, AlertCircle, Shield } from 'lucide-react';
...
export function MessagingPage() {
  ...
  const [mainTab, setMainTab] = useState('conversations'); // New state for main tab (conversations vs admin)
            ...
            <Tabs value={mainTab} onValueChange={setMainTab} className="h-full flex flex-col">
              <div className="border-b border-gray-200">
                <TabsList className="h-12 w-full justify-start rounded-none bg-transparent">
                  ...
                  <TabsTrigger 
                    value="admin" 
                    className="data-[state=active]:bg-amber-50 data-[state=active]:text-amber-700 data-[state=active]:border-b-2 data-[state=active]:border-amber-700"
                  >
              ...
              {/* Conversations Tab */}
              <TabsContent value="conversations" className="flex-1 m-0 h-full">
              ...
              {/* Admin Messages Tab */}
              <TabsContent value="admin" className="flex-1 m-0 h-full">
                <div className="h-full overflow-auto p-4">
                  <UserAccessGuard allowedPages={['messaging']}>
                    <AdminMessages userId={user?.id || ''} />
                  </UserAccessGuard>
                </div>
              </TabsContent>
            </Tabs>
