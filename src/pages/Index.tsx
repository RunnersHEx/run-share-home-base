      ...
      <section className="relative overflow-hidden page-gradient">
        ...
        <div className="container mx-auto px-4 py-16 lg:py-24 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            {/* Quick Search */}
            <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-xl max-w-2xl mx-auto mb-8 animate-slide-in-right">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Destino</label>
                  <Input placeholder="¿Dónde quieres correr?" className="runner-input" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Fecha</label>
                  <Input type="date" className="runner-input" />
                </div>
                <div>
                  ...
                  <Select>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="half">Media Maratón</SelectItem>
              ...
              <Button className="runner-button-primary w-full mt-4">
