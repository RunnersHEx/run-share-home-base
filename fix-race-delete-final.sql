-- COMPLETELY CLEAN ADMIN_DELETE_RACE FUNCTION
-- Renamed all parameters to eliminate any possible ambiguity
...
SELECT 'admin_delete_race function created successfully' as status;
