-- FULL VERSION - Apply this AFTER the minimal version works
-- DROP AND RECREATE ADMIN_DELETE_RACE FUNCTION WITH FULL FUNCTIONALITY
...
SELECT 'admin_delete_race function recreated with full functionality' as status;
